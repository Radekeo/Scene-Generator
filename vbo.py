...
class CubeVBO(BaseVBO):
    ...
    def get_vertex_data(self):
        vertices = [(-0.75, -0.75, 0.75), ( 0.75, -0.75,  0.75), (0.75,  0.75,  0.75), (-0.75, 0.75,  0.75),
        ...
        tex_coord_indices = [(0, 2, 3), (0, 1, 2),
                             ...
                             (0, 2, 3), (0, 1, 2),
                             (3, 1, 2), (3, 0, 1),]
        texture_data = self.get_data(tex_coord_vertices, tex_coord_indices)
